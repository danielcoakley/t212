...
This directory describes the local ISA system starter: architecture,
source caveats, runbooks, ISA notes, dashboard layout, and future Codex
extension prompts.
...
| Document | Purpose |
| --- | --- |
| `architecture.md` | System boundaries, planes, and control flow. |
| `data_sources.md` | Official, convenience, optional, and rate-constrained source notes. |
